...
useEffect(() => {
 ...
 const login = useCallback(() => {
  ...
  window.FB.login(
    ...
    {
      scope:
        "instagram_basic,public_profile,business_management,instagram_manage_comments,instagram_manage_messages,pages_show_list,pages_read_engagement,pages_manage_metadata",
      return_scopes: true,
    }
  );
}, [sdkReady]);
