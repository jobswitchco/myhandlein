...
const sendMailForBookings = async (options) => {
    ...
    <tr>
      <td align="center">
        <table role="presentation" class="container">
              ...
              <table role="presentation" width="100%">
                ...
                <tr>
                  <td align="center" class="sub">
                    Hi ${customer_name}, your ${service_title.toLowerCase()} has been scheduled successfully.
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td class="px-24 py-32" align="center">
              <a href="${manage_url}" class="btn">Manage Booking</a>
            </td>
          </tr>
...
export default sendMailForBookings;
